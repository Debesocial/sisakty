...
if(isset($_SESSION['start_session'])){
	...
	if (!isset($_SESSION['user_id']) || $_SESSION['loginas'] != 'Administrator') {
		session_unset();
		session_destroy();
		header("location:index.php");
	}
				...
				<ul class="navbar-nav navbar-right">
					<li class="dropdown">
						<a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user" style="color: #60686f;">
							<u>Safety MIP </u>&nbsp;<i class="fas fa-user"></i>
					...
					<ul class="sidebar-menu">
						...
						<li class="dropdown">
							<a href="#" class="menu-toggle nav-link has-dropdown">
								<i class="fas fa-database"></i><span>Data Karyawan</span>
							</a>
						...
						<li class="dropdown">
							<a href="#" class="menu-toggle nav-link has-dropdown">
								<i class="fas fa-database"></i><span>Data Harmonis</span>
							</a>
							<ul class="dropdown-menu">
						...
						<li class="dropdown">
							<a href="#" class="menu-toggle nav-link has-dropdown">
								<i class="fas fa-newspaper"></i><span>Bulletin</span>
							</a>
							<ul class="dropdown-menu">
								<li><a class="nav-link" href="home.php?v=mbulletin&act=add">SHE Bulletin</a></li>
								<li><a class="nav-link" href="home.php?v=miupdate&act=add">Info Update</a></li>
							</ul>
						</li>
						<li class="dropdown">
