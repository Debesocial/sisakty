...
// $objPHPExcel->getActiveSheet()->setCellValue('C3', 'JAN');
// $objPHPExcel->getActiveSheet()->setCellValue('D3', 'FEB');
// $objPHPExcel->getActiveSheet()->setCellValue('E3', 'MAR');
// $objPHPExcel->getActiveSheet()->setCellValue('F3', 'APR');
// $objPHPExcel->getActiveSheet()->setCellValue('G3', 'MEI');
// $objPHPExcel->getActiveSheet()->setCellValue('H3', 'JUN');
// $objPHPExcel->getActiveSheet()->setCellValue('I3', 'JUL');
// $objPHPExcel->getActiveSheet()->setCellValue('J3', 'AGU');
// $objPHPExcel->getActiveSheet()->setCellValue('K3', 'SEP');
// $objPHPExcel->getActiveSheet()->setCellValue('L3', 'OKT');
// $objPHPExcel->getActiveSheet()->setCellValue('M3', 'NOV');
// $objPHPExcel->getActiveSheet()->setCellValue('N3', 'DES');
// $objPHPExcel->getActiveSheet()->setCellValue('O3', 'Total');
...
// 	$objPHPExcel->getActiveSheet()->setCellValue('C'.$row, $mdiv['jan']);
// 	$objPHPExcel->getActiveSheet()->setCellValue('D'.$row, $mdiv['feb']);
// 	$objPHPExcel->getActiveSheet()->setCellValue('E'.$row, $mdiv['mar']);
// 	$objPHPExcel->getActiveSheet()->setCellValue('F'.$row, $mdiv['apr']);
// 	$objPHPExcel->getActiveSheet()->setCellValue('G'.$row, $mdiv['mei']);
// 	$objPHPExcel->getActiveSheet()->setCellValue('H'.$row, $mdiv['jun']);
// 	$objPHPExcel->getActiveSheet()->setCellValue('I'.$row, $mdiv['jul']);
// 	$objPHPExcel->getActiveSheet()->setCellValue('J'.$row, $mdiv['agu']);
// 	$objPHPExcel->getActiveSheet()->setCellValue('K'.$row, $mdiv['sep']);
// 	$objPHPExcel->getActiveSheet()->setCellValue('L'.$row, $mdiv['okt']);
// 	$objPHPExcel->getActiveSheet()->setCellValue('M'.$row, $mdiv['nov']);
// 	$objPHPExcel->getActiveSheet()->setCellValue('N'.$row, $mdiv['des']);
// 	$objPHPExcel->getActiveSheet()->setCellValue('O'.$row, $total = $mdiv['jan']+$mdiv['feb']+$mdiv['mar']+$mdiv['apr']+$mdiv['mei']+$mdiv['jun']+$mdiv['jul']+$mdiv['agu']+$mdiv['sep']+$mdiv['okt']+$mdiv['nov']+$mdiv['des']);
// 	$row++;
// }
// //--------------------------------------------------------------------------------------------------
