...
$pdf->SetTextColor(29);
$pdf->SetXY(42.5, 25);
$pdf->Image('../../assets/images/BACKGROUNDZ.jpg', 30, 10, 140, 90);
...
$pdf->SetXY(53, 12);
$pdf->Cell(44, 7, 'PT. MANDIRI INTIPERKASA', 0, 4, 'L');
$pdf->SetFont('Arial', '', 5);
$pdf->SetXY(53, 14.5);
$pdf->Cell(29.5, 7, 'SITE KRASSI, SEMBAKUNG -', 0, 4, 'L');
$pdf->SetXY(53, 17);
$pdf->Cell(53, 7, 'NUNUKAN - KALTARA', 0, 4, 'L');
$pdf->Line(43, 22.5, 84, 22.5);
...
$pdf->SetFont('Arial', 'B', 5);
$pdf->SetXY(67, 59);
$pdf->Image('../../assets/images/TTD Pak Robby.png', 63, 55, 22, 22);
...
$pdf->SetFont('Arial', '', 7);
$pdf->Image('../../assets/images/LOGOX.png', 42, 13, 12, 9);
$pdf->SetFont('Arial', '', 7);
