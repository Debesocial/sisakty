...
<?php if(@$_GET['status'] == 'all') {?>
    ...
    <section class="margin-b-20 emPage__CateJobs withOut_colorful padding-l-20 padding-r-20 padding-t-70">
        <a href="home.php?v=hazard-pic&status=open" class="emCategorie_itemJobs _list bg-yellow">
            <div class="icon">
        ...
        <div class="txt">
        	...
        	where hazard.hazard_divisi = '$_divisiid'
    ...
    <a href="home.php?v=hazard-pic&status=progress" class="emCategorie_itemJobs _list bg-blue">
        <div class="icon">
            <svg id="Iconly_Bulk_Chart" data-name="Iconly/Bulk/Chart" xmlns="http://www.w3.org/2000/svg"
            width="20" height="20" viewBox="0 0 20 20">
            <g id="Chart" transform="translate(1.667 1.667)">
...
<a href="home.php?v=hazard-pic&status=closed" class="emCategorie_itemJobs _list bg-green">
    <div class="icon">
        <svg id="Iconly_Bulk_Chart" data-name="Iconly/Bulk/Chart" xmlns="http://www.w3.org/2000/svg"
        width="20" height="20" viewBox="0 0 20 20">
        <g id="Chart" transform="translate(1.667 1.667)">
...
<a href="home.php?v=hazard-pic&status=rejected" class="emCategorie_itemJobs _list bg-red">
    <div class="icon">
        <svg id="Iconly_Bulk_Chart" data-name="Iconly/Bulk/Chart" xmlns="http://www.w3.org/2000/svg"
        width="20" height="20" viewBox="0 0 20 20">
        <g id="Chart" transform="translate(1.667 1.667)">
...
<div class="em_bodyCarousel padding-t-0">
        ...
        if(isset($_POST["submit"])){
            ...
            if(@$_GET['status'] == 'all') {
                $sql = mysqli_query($conn,"SELECT * FROM hazard  
                    ...
                    AND hazard.hazard_divisi = '$_divisiid'
        ...
        while(@$row = mysqli_fetch_array($sql)) {
            ...
            <a href="home.php?v=hazard-detail-pic&id='.base64_encode($row['hazard_id']).'" class="card margin-b-20">
