										...
										<?php while($row  = mysqli_fetch_array($classi)){ 
											...
											<tr>
												...
												<td>
													...
													where hazard_classi = ".$row['classi_id']." and DATE_FORMAT(hazard_date, '%Y-%m-%d') >= '$date1' and DATE_FORMAT(hazard_date, '%Y-%m-%d') <= '$date2'"));  $classi_g_[] = $classi_['total']; echo $classi_['total'];?> 
												</td>
											</tr>
										<?php } ?>
									</tbody>
										...
										<?php while($row  = mysqli_fetch_array($risk)){ 
											...
											<tr>
												...
												<td>
													...
													where hazard_risk = ".$row['risk_id']." and DATE_FORMAT(hazard_date, '%Y-%m-%d') >= '$date1' and DATE_FORMAT(hazard_date, '%Y-%m-%d') <= '$date2'")); $risk_g_[] = $risk_['total']; echo $risk_['total'];?>
												</td>
											</tr>
										<?php } ?>
									</tbody>
