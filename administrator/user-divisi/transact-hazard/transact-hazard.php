...
@$open=mysqli_fetch_array($conn->query("SELECT COUNT(*) AS total FROM hazard 
  ...
  and hazard_comp = ".$_SESSION['user_comp']."
  and hazard_divisi = ".$_SESSION['user_divisi'].""));

@$progress=mysqli_fetch_array($conn->query("SELECT COUNT(*) AS total FROM hazard 
  where hazard_approve = 'Y' 
        ...
        <div class="col-md-12">
          <div class="form-row">
            ...
            <div class="col">
              ...
              <input name="comp" type="text" class="form-control" hidden value=<?= $_SESSION['user_comp']?> >
            </div>
            <div class="col">
    ...
    @$month=mysqli_fetch_array($conn->query("SELECT 
      ...
      <div class="tab-content" id="myTabContent">
        ...
        <div class="tab-pane fade" id="summary" role="tabpanel" aria-labelledby="summary-tab">
          <a target="_blank" href="transact-hazard/filter/export.php?d1=<?php echo $date1;?>&d2=<?php echo $date2;?>&comp=<?php echo $_SESSION['user_comp'];?>&div=<?php echo $_SESSION['user_divisi'];?>">
            <button class="btn btn-outline-success form-control">
              <i class="fas fa-download"></i> Export Summary
            </button>
          </a><br><br> <div id="summarys"> 
            <div class="row"> 
                          ...
                          <tr>
                            ...
                            <td>
                              <?php @$classi_=mysqli_fetch_array($conn->query("SELECT COUNT(*) AS total FROM hazard 
                                LEFT JOIN company ON company.comp_id = hazard.hazard_comp
                                where hazard.hazard_classi = ".$row['classi_id']." 
                                and DATE_FORMAT(hazard.hazard_date, '%Y-%m-%d') >= '$date1' 
                                and DATE_FORMAT(hazard.hazard_date, '%Y-%m-%d') <= '$date2'
                                AND company.comp_id = ".$_SESSION['user_comp']."
                                and hazard_divisi = ".$_SESSION['user_divisi'].""));  
                                $classi_g_[] = $classi_['total']; echo $classi_['total'];?> 
                              </td>
                            </tr>
                          <?php } ?>
                        </tbody>
                            ...
                            <tr>
                              ...
                              <td>
                                <?php @$risk_=mysqli_fetch_array($conn->query("SELECT COUNT(*) AS total FROM hazard 
                                  LEFT JOIN company ON company.comp_id = hazard.hazard_comp
                                  where hazard.hazard_risk = ".$row['risk_id']." 
                                  and DATE_FORMAT(hazard.hazard_date, '%Y-%m-%d') >= '$date1' 
                                  and DATE_FORMAT(hazard.hazard_date, '%Y-%m-%d') <= '$date2'
                                  AND company.comp_id = ".$_SESSION['user_comp']."
                                  and hazard_divisi = ".$_SESSION['user_divisi']."")); 
                                  $risk_g_[] = $risk_['total']; echo $risk_['total'];?>
                                </td>
                              </tr>
                            <?php } ?>
                          </tbody>
                      ...
                      <div class="card-body">
                        <table class="table table-striped table-sm">
                          ...
                          <tbody>
                            ...
                            <tr>
                              <td>Progress</td>
                              <td><?php echo $status['Progress'];?></td>
                            </tr>
                            <tr>
                              <td>Closed</td>
                      ...
                      <div class="card-body">
                        <table class="table table-striped table-sm" id="tablesum1" >
                          ...
                          <tbody>
                            <tr>
                              <td>Januari</td>
                              <td><?php echo $month['jan'];?></td>
                            </tr>
                            <tr>
                              <td>Februari</td>
                              <td><?php echo $month['feb'];?></td>
                            </tr>
                            <tr>
                              <td>Maret</td>
                              <td><?php echo $month['mar'];?></td>
                            </tr>
                            <tr>
                              <td>April</td>
                              <td><?php echo $month['apr'];?></td>
                            </tr>
                            <tr>
                              <td>Mei</td>
                              <td><?php echo $month['mei'];?></td>
                            </tr>
                            <tr>
                              <td>Juni</td>
                              <td><?php echo $month['jun'];?></td>
                            </tr>
                            <tr>
                              <td>Juli</td>
                              <td><?php echo $month['jul'];?></td>
                            </tr>
                            <tr>
                              <td>Agustus</td>
                              <td><?php echo $month['agu'];?></td>
                            </tr>
                            <tr>
                              <td>September</td>
                              <td><?php echo $month['sep'];?></td>
                            </tr>
                            <tr>
                              <td>Oktober</td>
                            ...
                            <tr>
                              <td>November</td>
                              <td><?php echo $month['nov'];?></td>
                            </tr>
                            <tr>
                              <td>Desember</td>
                              <td><?php echo $month['des'];?></td>
                            </tr>
                          </tbody>
                        </table>
                      </div>
                              ...
                              <tr>
                                ...
                                <td>
                                  <?php @$location_=mysqli_fetch_array($conn->query("SELECT COUNT(*) AS total FROM hazard 
                                    LEFT JOIN company ON company.comp_id = hazard.hazard_comp
                                    where hazard_loc = ".$row['loc_id']." 
                                    and DATE_FORMAT(hazard.hazard_date, '%Y-%m-%d') >= '$date1' 
                                    and DATE_FORMAT(hazard.hazard_date, '%Y-%m-%d') <= '$date2'
                                    AND company.comp_id = ".$_SESSION['user_comp']."
                                    and hazard_divisi = ".$_SESSION['user_divisi']."")); 
                                    $location_g_[]= $location_['total']; echo $location_['total'].'';?>
                                  </td>
                                </tr>
                              <?php } ?>
                            </tbody>
