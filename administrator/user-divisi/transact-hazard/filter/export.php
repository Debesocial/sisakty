...
$hazard = mysqli_query($conn,"SELECT * FROM hazard 
	...
	AND hazard.hazard_comp = '$comp'
	AND hazard.hazard_divisi = '$divisi'");
$row = 4;
...
while($classi_data = mysqli_fetch_array($classi))
{
	$classi_= mysqli_fetch_array($conn->query("SELECT COUNT(*) AS total FROM hazard 
		where hazard_classi = ".$classi_data['classi_id']." 
		and DATE_FORMAT(hazard_date, '%Y-%m-%d') >= '$date1' 
		and DATE_FORMAT(hazard_date, '%Y-%m-%d') <= '$date2'
		AND hazard_comp = '$comp'
		AND hazard_divisi = '$divisi'"));
...
while($risk_data = mysqli_fetch_array($risk))
{
	$risk_=mysqli_fetch_array($conn->query("SELECT COUNT(*) AS total FROM hazard 
		where hazard_risk = ".$risk_data['risk_id']." 
		and DATE_FORMAT(hazard_date, '%Y-%m-%d') >= '$date1' 
		and DATE_FORMAT(hazard_date, '%Y-%m-%d') <= '$date2'
		AND hazard_comp = '$comp'
		AND hazard_divisi = '$divisi'"));
...
while($loc_data = mysqli_fetch_array($loc))
{
	$loc_=mysqli_fetch_array($conn->query("SELECT COUNT(*) AS total FROM hazard 
		where hazard_loc = ".$loc_data['loc_id']." 
		and DATE_FORMAT(hazard_date, '%Y-%m-%d') >= '$date1' 
		and DATE_FORMAT(hazard_date, '%Y-%m-%d') <= '$date2'
		AND hazard_comp = '$comp'
		AND hazard_divisi = '$divisi'"));
...
// $objPHPExcel->getActiveSheet()->setCellValue('D3', 'JAN');
// $objPHPExcel->getActiveSheet()->setCellValue('E3', 'FEB');
// $objPHPExcel->getActiveSheet()->setCellValue('F3', 'MAR');
// $objPHPExcel->getActiveSheet()->setCellValue('G3', 'APR');
// $objPHPExcel->getActiveSheet()->setCellValue('H3', 'MEI');
// $objPHPExcel->getActiveSheet()->setCellValue('I3', 'JUN');
// $objPHPExcel->getActiveSheet()->setCellValue('J3', 'JUL');
// $objPHPExcel->getActiveSheet()->setCellValue('K3', 'AGU');
// $objPHPExcel->getActiveSheet()->setCellValue('L3', 'SEP');
// $objPHPExcel->getActiveSheet()->setCellValue('M3', 'OKT');
// $objPHPExcel->getActiveSheet()->setCellValue('N3', 'NOV');
// $objPHPExcel->getActiveSheet()->setCellValue('O3', 'DES');
...
// 		where DATE_FORMAT(hazard_date, '%Y-%m-%d') >= '$date1' 
// 		AND DATE_FORMAT(hazard_date, '%Y-%m-%d') <= '$date2'
// 		AND hazard_divisi = ".$divisi_data['divisi_id']."
// 		AND hazard_comp = '$comp'"));
...
// 	$objPHPExcel->getActiveSheet()->setCellValue('D'.$row, $mdiv['jan']);
// 	$objPHPExcel->getActiveSheet()->setCellValue('E'.$row, $mdiv['feb']);
// 	$objPHPExcel->getActiveSheet()->setCellValue('F'.$row, $mdiv['mar']);
// 	$objPHPExcel->getActiveSheet()->setCellValue('G'.$row, $mdiv['apr']);
// 	$objPHPExcel->getActiveSheet()->setCellValue('H'.$row, $mdiv['mei']);
// 	$objPHPExcel->getActiveSheet()->setCellValue('I'.$row, $mdiv['jun']);
// 	$objPHPExcel->getActiveSheet()->setCellValue('J'.$row, $mdiv['jul']);
// 	$objPHPExcel->getActiveSheet()->setCellValue('K'.$row, $mdiv['agu']);
// 	$objPHPExcel->getActiveSheet()->setCellValue('L'.$row, $mdiv['sep']);
// 	$objPHPExcel->getActiveSheet()->setCellValue('M'.$row, $mdiv['okt']);
// 	$objPHPExcel->getActiveSheet()->setCellValue('N'.$row, $mdiv['nov']);
// 	$objPHPExcel->getActiveSheet()->setCellValue('O'.$row, $mdiv['des']);
// 	$objPHPExcel->getActiveSheet()->setCellValue('P'.$row, $total = $mdiv['jan']+$mdiv['feb']+$mdiv['mar']+$mdiv['apr']+$mdiv['mei']+$mdiv['jun']+$mdiv['jul']+$mdiv['agu']+$mdiv['sep']+$mdiv['okt']+$mdiv['nov']+$mdiv['des']);
// 	$row++;
// }
// //--------------------------------------------------------------------------------------------------
