...
if($_GET['action'] == 'visitor' ){
	...
	if($_GET['act'] == 'add') {
		$sql      = "INSERT INTO visitor (visitor_no, visitor_name, visitor_company, visitor_phone, visitor_needs, visitor_identity, visitor_permission, visitor_photo, visitor_end, visitor_status, visitor_date) VALUES ('$idcard','$name','$company','$phone','$needs','$ktp','$suratizin','$photo','$end', 'Aktif','$tanggal')";
