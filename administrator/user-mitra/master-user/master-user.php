						...
						<div class="row">
							<div class="col-md-4 col-lg-4 col-xl-4">
								<div class="form-group">
									...
									<input type="text" class="form-control" id="" required placeholder="NIK" name="nik" autocomplete="off" minlength="4">
								</div>
								<div class="form-group">
									<label>Password</label>
									<input type="Password" class="form-control" id="" required placeholder="Password" name="password" autocomplete="off" minlength="6">
								</div>
								<div class="form-group">
							...
							<div class="col-md-4 col-lg-4 col-xl-4">
								...
								<div class="form-group">
									...
									<select class="form-control select2" id="" required name="comp">
										<?php $comp_name =  mysqli_fetch_array($conn->query("SELECT * FROM company where comp_id = ".$_SESSION['user_comp'].""));?>
										<option value=<?= $_SESSION['user_comp']?>> <?= $comp_name['comp_name'] ?></option>
									</select>
								</div>
								<div class="form-group">
									<label>Divisi</label>
									<select class="form-control select2" id="" required name="divisi">
										<option value=""> - Pilih Divisi -</option>
										<?php $data = mysqli_query($conn,"select * from divisi where divisi_comp = ".$_SESSION['user_comp']."");
							...
							<div class="col-md-4 col-lg-4 col-xl-4">
								<div class="form-group">
									...
									<select class="form-control select2" id="" required name="dept">
										<option value=""> - Pilih Departement -</option>
										<?php $data = mysqli_query($conn,"select * from departement where dept_comp = ".$_SESSION['user_comp'].""); 
										while($row  = mysqli_fetch_array($data)){ ?> 
								...
								<div class="form-group">
									<label>Jabatan</label>
									<select class="form-control select2" id="" required name="level">
										<option value=""> - Pilih Jabatan -</option>
										<?php $data = mysqli_query($conn,"select * from level where level_comp = ".$_SESSION['user_comp']."");
										while($row  = mysqli_fetch_array($data)){ ?> 
