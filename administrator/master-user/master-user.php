							...
							<div class="col-md-4 col-lg-4 col-xl-4">
								<div class="form-group">
									...
									<select class="form-control select2" id="dept" required name="dept">
										...
										while($row  = mysqli_fetch_array($data)){ ?> 
											<option value=<?= $row['dept_comp'].'-'.$row['dept_id'];?>>
												<?= $row['dept_name'];
											}?> 
										</option>
									</select>
								...
								<div class="form-group">
									...
									<select class="form-control select2" id="level" required name="level">
										...
										while($row  = mysqli_fetch_array($data)){ ?> 
											<option value=<?= $row['level_comp'].'-'.$row['level_id'];?>>
												<?= $row['level_name'];
											}?> 
										</option>
									</select>
								...
								<div class="form-group">
									...
									<div class="form-check">
										<input type="checkbox" class="form-check-input" id="exampleCheck1" name="pic" value="Y">
							...
							<div class="row">
								...
								<div class="col-md-4 col-lg-4 col-xl-4">
									...
									<!-- <div class="form-group">
										...
										<select class="form-control select2" id="loginas" name="loginas">
											<option value=""> User Apps</option>
											<option value="pic"> Admin Divisi / Safety Mitra Kerja</option>
						...
						<div class="row">
							<div class="col-md-4 col-lg-4 col-xl-4">
								...
								<div class="form-group">
									<label>Tanggal Lahir</label>
									<input type="date" class="form-control" id="" placeholder="Tanggal Lahir" name="birth"
									value="<?= $userupdate['user_birth']?>">
								</div>
								<div class="form-group">
									<label>No. Telp</label>
									<input type="number" class="form-control" id="" required placeholder="No. Telp" name="phone"
									value="<?= $userupdate['user_phone']?>">
								</div>
							</div>
							...
							<div class="col-md-4 col-lg-4 col-xl-4">
								...
								<div class="form-group">
									<label>Masuk Site</label>
									<input type="date" class="form-control" id="" required placeholder="Masuk Site" name="onsite"
									value="<?= $userupdate['user_onsite']?>">
								</div>
								<div class="form-group">
									<label>Status</label>
									<select class="form-control select2" id="" required name="status">
										<option value="<?= $userupdate['user_status']?>"><?= $userupdate['user_status']?></option>
										<option value="STAFF">STAFF</option>
										<option value="NON STAFF">NON STAFF</option>
									</select>
								</div>
								<div class="form-group">
									<label>Perusahaan</label>
									<select class="form-control select2" id="comp" required name="comp">
										<option value="<?= $userupdate['user_comp']?>">
								...
								<div class="form-group">
									<label>Divisi</label>
									<select class="form-control select2" id="divisi" required name="divisi">
										<option value=<?= $userupdate['user_comp'].'-'.$userupdate['user_divisi'];?>>
							...
							<div class="col-md-4 col-lg-4 col-xl-4">	
								<div class="form-group">
									<label>Departement</label>
									<select class="form-control select2" id="dept" required name="dept">
										<option value=<?= $userupdate['user_comp'].'-'.$userupdate['user_dept'];?>>
								...
								<div class="form-group">
									<label>Jabatan</label>
									<select class="form-control select2" id="level" required name="level">
										<option value=<?= $userupdate['user_comp'].'-'.$userupdate['user_level'];?>>
								...
								<div class="form-group">
									<label>Akses Apps</label>
									<select class="form-control select2" id="level" name="access">
										<?php if ($userupdate['user_access'] == 'Y'){
											echo'<option value="Y"> Aktif</option>';
										} else {
											echo'<option value=""> Nonaktif</option>';
										}?>
										<option value="Y"> Aktif</option>
										<option value=""> Nonaktif</option>
									</select>
								...
								<div class="form-group">
									...
									<div class="form-check">
										<?php if( $userupdate['user_pic'] == 'Y' ) {?>
											<input type="checkbox" class="form-check-input" id="exampleCheck1" name="pic" value="Y" Checked>
										<?php } else { ?>
											<input type="checkbox" class="form-check-input" id="exampleCheck1" value="" name="pic" >
										<?php } ?>
										<label class="form-check-label" for="exampleCheck1">Set sebagai PIC</label>
=======
		<!-- UPDATE DATA USER -------------------------------------------------------------------------------------------------------------->
						...
						<div class="card-body">
							<div class="row">
								<div class="col-md-4 col-lg-4 col-xl-4">
									...
									<div class="form-group">
										<label>NIK / User ID</label>
										<input type="text" class="form-control" id="" required placeholder="NIK" name="nik" value="<?php echo $userupdate['user_nik'] ?>">
									</div>
									<div class="form-group">
										<label>Password</label>
										<input type="Password" class="form-control" id="" required placeholder="Password" name="password" value="<?php echo base64_decode($userupdate['user_password']) ?>">
									</div>
									<div class="form-group">
										<label>Nama Lengkap</label>
										<input type="text" class="form-control" id="" required placeholder="Nama Lengkap" name="name" value="<?php echo $userupdate['user_name'] ?>">
									</div>
									<div class="form-group">
										<label>Tanggal Lahir</label>
										<input type="date" class="form-control" id="" placeholder="Tanggal Lahir" name="birth" value="<?php echo $userupdate['user_birth'] ?>">
									</div>
									<div class="form-group">
										<label>No. Telp</label>
										<input type="number" class="form-control" id="" required placeholder="No. Telp" name="phone" value="<?php echo $userupdate['user_phone'] ?>">
									</div>
								</div>
								...
								<div class="col-md-4 col-lg-4 col-xl-4">
									<div class="form-group">
										<label>Email</label>
										<input type="email" class="form-control" id="" required placeholder="Email" name="email" value="<?php echo $userupdate['user_email'] ?>">
									</div>
									<div class="form-group">
										<label>Masuk Site</label>
										<input type="date" class="form-control" id="" required placeholder="Masuk Site" name="onsite" value="<?php echo $userupdate['user_onsite'] ?>">
									</div>
									<div class="form-group">
										<label>Status</label>
										<select class="form-control select2" id="" required name="status">
										...
										<div class="form-group">
											...
											<select class="form-control select2" id="dept" required name="dept">
												<option value=<?php echo $userupdate['user_comp'] . '-' . $userupdate['user_dept']; ?>>
													<?php @$dept = mysqli_fetch_array($conn->query("SELECT * FROM departement left join company ON company.comp_id = departement.dept_comp where departement.dept_id = " . $userupdate['user_dept'] . ""));
													echo $dept['dept_name']; ?>
												</option>
												<?php $data = mysqli_query($conn, "select * from departement order by dept_name asc");
												while ($row  = mysqli_fetch_array($data)) { ?>
										...
										<div class="form-group">
											...
											<select class="form-control select2" id="level" required name="level">
												<option value=<?php echo $userupdate['user_comp'] . '-' . $userupdate['user_level']; ?>>
													<?php @$dept = mysqli_fetch_array($conn->query("SELECT * FROM level left join company ON company.comp_id = level.level_comp where level.level_id = " . $userupdate['user_level'] . ""));
													echo $dept['level_name']; ?>
												</option>
												<?php $data = mysqli_query($conn, "select * from level order by level_name asc");
												while ($row  = mysqli_fetch_array($data)) { ?>
													<option value=<?php echo $row['level_comp'] . '-' . $row['level_id']; ?>>
									...
									<!-- <div class="form-group">
										...
										<select class="form-control select2" id="loginas" name="loginas">
											<?php if ($userupdate['user_pic'] == 'Y') { ?>
												<option value="pic"> Admin Divisi / Safety Mitra Kerja</option>
											<?php } elseif ($userupdate['user_pic'] == 'resepsionis') { ?>
												<option value="resepsionis"> Resepsionis</option>
											<?php } elseif ($userupdate['user_pic'] == '') { ?>
												<option value=""> User Apps</option>
											<?php } elseif ($userupdate['user_pic'] == 'KTT') { ?>
												<option value="ktt"> KTT</option>
											<?php } ?>
											<option value=""> User Apps</option>
											<option value="pic"> Admin Divisi / Safety Mitra Kerja</option>
			...
			<div class="card author-box">
				<div class="card-body">
					<div class="author-box-center">
						...
						<?php if(@$minepermit['mpermit_photo'] != '' && $minepermit['mpermit_status_approval'] == 'Closed'){?>
			...
			<div class="col-12 col-md-12 col-lg-7">
				<div class="card">
					<div class="padding-20">
						<ul class="nav nav-tabs" id="myTab2" role="tablist">
							<li class="nav-item">
								<a class="nav-link active" id="profile-tab2" data-toggle="tab" href="#mpermit" role="tab" aria-selected="true"><b>Mine Permit</b></a>
							</li>
							<li class="nav-item">
								<a class="nav-link" id="profile-tab2" data-toggle="tab" href="#spermit" role="tab" aria-selected="false"><b>SIM Permit</b></a>
							</li>
						</ul>
...
=======
												...
												<br>
												<H6>Timeline Pengajuan Mine Permit</H6>
												<hr>
												<div class="form-group col-12">
													<small>
														<div id="tracking">
...
=======
										...
										<br>
										<H6>Histori Pengajuan Mine Permit</H6>
										<hr>
										<div class="table-responsive">
											<table class="table table-striped table-hover" id="" style="width:100%;">
												<thead>
...
<<<<<<< Updated upstream
								...
								<?php if (@$minepermit_detail['mpermit_photo'] != NULL){?>
									<div class="form-group col-5">
										<label>Foto</label>
									</div>
									<div class="form-group col-7">
...
<script type="text/javascript">
	$(document).ready(function() {
		$("#form-user-update").on("submit", function(e) {
			...
			$.ajax({
<<<<<<< Updated upstream
				url  : "action/action.php?action=user&act=update&id=<?= $userupdate['user_id'];?>",
				type : "POST",
				cache:false,
				data :formData,
				contentType : false, 
