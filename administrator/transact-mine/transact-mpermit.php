...
<div class="form-group" id="beritaacara" style="display:none;">
  <label>Berita Acara Kehilangan</label><br>
...
<div class="col-2">
  <form action="" method="post">
   <button name="open" value="open" class="btn btn-success form-control">APPROVAL</button>
 </form>
</div>
</div>
</center><br>
...
<td style="text-align: right">
  ...
  <?php if($row['mpermit_status_approval'] == 'Cancel' 
   || $row['mpermit_status_approval'] == 'Reject'
   || $row['mpermit_status_approval'] == 'Closed'
   || ($row['mpermit_submitter'] == 'Mitra Kerja' && $row['mpermit_status_approval'] == 'Progress')) {

    if($row['mpermit_submitter'] == 'Safety MIP' ) {?>
